...
function build_android44 (){
	...
	rm -f BackupRestoreConfirmation.apk InputDevices.apk Launcher3.apk OpenDelta.apk VoiceDialer.apk CMS.apk CMUpdater.apk SharedStorageBackup.apk Trebuchet.apk
	echo "App Cleaning DONE!"
	sleep 2
	echo ""
	echo "Cleaning Libs..."
