...
function build_android44 (){
	...
	cd $currentdir/system/app
	echo "Cleaning Apps..."
	rm -fv Apollo.apk ApplicationsProvider.apk BasicDreams.apk Browser.apk Calculator.apk CMAccount.apk CMFileManager.apk CMUpdater.apk CMWallpapers.apk DocumentsUI.apk DownloadProviderUi.apk DSPManager.apk Email.apk	Email2.apk Exchange2.apk FM2.apk  FmRadio.apk FMRecord.apk Galaxy4.apk HoloSpiralWallpaper.apk HTMLViewer.apk InputDevices.apk LiveWallpapers.apk LiveWallpapersPicker.apk LockClock.apk MagicSmokeWallpapers.apk MonthCalendarWidget.apk NoiseField.apk OmniTorch.apk OpenWnn.apk PacProcessor.apk PhaseBeam.apk PhotoTable.apk PicoTts.apk QuickSearchBox.apk SharedStorageBackup.apk Shell.apk SoundRecorder.apk Stk.apk Term.apk Torch.apk Trebuchet.apk VideoEditor.apk VisualizationWallpapers.apk VoiceDialer.apk VoicePlus.apk webaudiores.apk WhisperPush.apk
	cd $currentdir/system/priv-app
	rm -fv BackupRestoreConfirmation.apk InputDevices.apk Launcher3.apk OpenDelta.apk VoiceDialer.apk CMS.apk CMUpdater.apk SharedStorageBackup.apk Trebuchet.apk PicoTts.apk
	echo "App Cleaning DONE!"
	sleep 2
	echo ""
	echo "Cleaning Libs..."
